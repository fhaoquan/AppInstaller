...
namespace System.Windows.Forms
{
    public partial class CForm : Form
    {
       ...
       //ublic BaseForm skin;
        ...
        public Image BorderPalace
        {
            get
            {
                ...
                if (borderpalace == null)
                    borderpalace = res.Resources.BackPalace;
                return borderpalace;
            }
            set
            {
        ...
        {
            get { if (btnclose == null) btnclose = res.Resources.btnClose1; return btnclose; }
            set { btnclose = value; }
        }
        [Description("最小化按钮图片")]
        public Image btnMinImage
        {
            get { if (btnmin == null) btnmin = res.Resources.btnMin1; return btnmin; }
            set { btnmin = value; Invalidate(); }
        }
        [Description("最大化按钮图片")]
        public Image btnMaxImage
        {
            get { if (btnmax == null) btnmax = res.Resources.btnMax1; return btnmax; }
        ...
        {
            get { if (btnrestore == null) btnrestore = res.Resources.btnRestore1; return btnrestore; }
